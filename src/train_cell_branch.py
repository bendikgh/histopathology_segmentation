...
class CellTissueDataset(ImageDataset):
    ...
    def __getitem__(self, idx):
        ...
        # Scale and crop 
        image_tissue = get_tissue_croped_scaled_tensor(image_tissue, image_path, self.data_path)
...
def main():
    ...
    model_tissue.load_state_dict(torch.load("outputs/models/2023-12-02_00-17-23_deeplabv3plus_cell_only_lr-0.0001_dropout-0.3_backbone-resnet50_epochs-150.pth"))
    model_tissue.eval()

    train_cell_tissue_dataset = CellTissueDataset(image_files=train_image_files, seg_files=train_seg_files, image_tissue_files=train_tissue_image_files, model_tissue=model_tissue)
