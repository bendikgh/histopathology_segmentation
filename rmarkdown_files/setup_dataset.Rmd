...
```{python}
path = os.path.join("/cluster/projects/vc/data/mic/open/OCELOT/ocelot_data", "images/train/cell/288.jpg")
img = get_image_tensor_from_path(path)
...
## Test read data with fetch_images set to false
